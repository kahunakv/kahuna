...
/// <para>
/// Public because <see cref="IBackupArtifactStore"/> implementations live in separate assemblies and
/// signal artifact-integrity and path-safety failures with it.
/// </para>
/// </summary>
public sealed class BackupArtifactException : Exception
{
