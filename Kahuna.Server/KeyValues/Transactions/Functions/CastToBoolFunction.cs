...
internal static class CastToBoolFunction
{
    internal static KeyValueExpressionResult Execute(NodeAst ast, List<KeyValueExpressionResult> arguments)
    {
        ...
        return arguments[0].Type switch
        {
            ...
            KeyValueExpressionType.StringType => new() { Type = KeyValueExpressionType.BoolType, BoolValue = string.Compare(arguments[0].StrValue, "true", StringComparison.InvariantCultureIgnoreCase) == 0 },
