    ...
    internal static KeyValueExpressionResult Execute(NodeAst ast, List<KeyValueExpressionResult> arguments)
    {
        ...
        return arg1.Type switch
        {
            KeyValueExpressionType.LongType when arg2.Type == KeyValueExpressionType.LongType => 
                new() { Type = KeyValueExpressionType.DoubleType, DoubleValue = Math.Pow(arg1.LongValue, arg2.LongValue) },
            
            KeyValueExpressionType.LongType when arg2.Type == KeyValueExpressionType.DoubleType => 
                new() { Type = KeyValueExpressionType.DoubleType, DoubleValue = Math.Pow(arg1.LongValue, arg2.DoubleValue) },
            
            KeyValueExpressionType.DoubleType when arg2.Type == KeyValueExpressionType.LongType => 
                new() { Type = KeyValueExpressionType.DoubleType, DoubleValue = Math.Pow(arg1.DoubleValue, arg2.LongValue) },
            
            KeyValueExpressionType.DoubleType when arg2.Type == KeyValueExpressionType.DoubleType => 
                new() { Type = KeyValueExpressionType.DoubleType, DoubleValue = Math.Pow(arg1.DoubleValue, arg2.DoubleValue) },          
