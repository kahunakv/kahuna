...
public sealed class TestMembership : BaseCluster
{
    ...
    private sealed class StubKahunaForE5 : IKahuna
    {
        ...
        public Task<(KeyValueResponseType, HLCTimestamp, string, KeyValueDurability)> TryPrepareMutations(HLCTimestamp transactionId, HLCTimestamp commitId, string key, KeyValueDurability durability, long routedGeneration = 0, string? recordAnchorKey = null, CoordinatorDecisionRecord? embeddedDecision = null) => throw new NotImplementedException();
