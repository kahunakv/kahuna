...
public sealed class TestMembership : BaseCluster
{
    ...
    private sealed class StubKahunaForE5 : IKahuna
    {
        ...
        public Task<string?> LocateAndCompleteOperation(string coordinatorKey, HLCTimestamp transactionId, TransactionOperationId operationId, OperationCompletionPayload payload, CancellationToken cancellationToken) => throw new NotImplementedException();
