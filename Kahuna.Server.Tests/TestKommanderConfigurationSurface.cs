...
public sealed class TestKommanderConfigurationSurface
{
    private static readonly Dictionary<string, string> RaftToCliOptionProperties = new()
    {
        ...
        [nameof(RaftConfiguration.BackfillNoProgressPauseCap)] = nameof(KahunaCommandLineOptions.RaftBackfillNoProgressPauseCap),
        [nameof(RaftConfiguration.BackfillNoProgressAnchorFallbackShips)] = nameof(KahunaCommandLineOptions.RaftBackfillNoProgressAnchorFallbackShips),
        ...
        [nameof(RaftConfiguration.EnableSlowNodeAvoidance)] = nameof(KahunaCommandLineOptions.RaftEnableSlowNodeAvoidance),
        [nameof(RaftConfiguration.SlowNodeMultiplier)] = nameof(KahunaCommandLineOptions.RaftSlowNodeMultiplier),
        [nameof(RaftConfiguration.SlowNodeFloorMs)] = nameof(KahunaCommandLineOptions.RaftSlowNodeFloorMs),
        [nameof(RaftConfiguration.SlowNodeMinSamples)] = nameof(KahunaCommandLineOptions.RaftSlowNodeMinSamples),
        [nameof(RaftConfiguration.SlowNodeObservationTtl)] = nameof(KahunaCommandLineOptions.RaftSlowNodeObservationTtl),
        [nameof(RaftConfiguration.SlowNodeEnterPasses)] = nameof(KahunaCommandLineOptions.RaftSlowNodeEnterPasses),
        [nameof(RaftConfiguration.SlowNodeExitPasses)] = nameof(KahunaCommandLineOptions.RaftSlowNodeExitPasses),
